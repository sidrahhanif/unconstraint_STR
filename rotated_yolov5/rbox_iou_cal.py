...
def test_intersection_area(box1, box2):
    ...
    print(area)
    print(corners)
    a1, c1 = vertices2area(box1)
    a2, c2 = vertices2area(box2)
    print(a1)
    print(c1)
    print(a2)
    print(c2)
    print(area/(a1+a2-area))
...
#box1 = np.array([0, 0, 4, 4, np.pi/4])
#box2 = np.array([0, 0, 4, 4, 0])
...
def box2corners(x, y, w, h, alpha):
    ...
    rotated[:, 1] += y
    return rotated
#box1 = box2corners(*box1)
#box2 = box2corners(*box2)

box1 =  np.array([[     474.44   ,   274.52],
 [        471  ,       317],
 [     443.56   ,   399.48],
 [        447   ,      357]] )

box2 = np.array([[     473.16   ,    274.1],
 [     473.16    ,  311.59],
 [     428.95   ,   311.59],
 [     428.95   ,    274.1]])
