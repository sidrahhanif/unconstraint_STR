...
def load_online_dataloader(batch_size=1, shuffle=True, resample=True):
    train_data_path = "/home/tug85766/Trace/data_processing/online_coordinate_data/MAX_stroke_vNORMAL_TRAINING_TESTSmall_1000/test_online_coords.json"
    extension = ".tif"
...
def main(config_path):
    ...
    for load_path_override in [load_path_override
        ...
        if not ONLINE:
            ...
            fpath = "/home/tug85766/Trace/data_processing/online_coordinate_data/MAX_stroke_vNORMAL_TRAINING_TESTSmall_1000/test_online_coords.npy"
...
"""
config_path = "/home/tug85766/Trace/example_weights/config.yaml"
load_path_override = "/home/tug85766/Trace/example_weights/example_weights.pt"
...
KDTREE_PATH = "./RESULTS/{}_PREDS/kd_trees{}.npy".format(ONLINE_OR_OFFLINE, vers)
LOAD_KDTREE = False
SAVE_KD = False
NN_DISTANCES = False
